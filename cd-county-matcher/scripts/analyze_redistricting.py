...
(year-shifted version).

Analyzes congressional district changes over time to identify redistricting
events, using the year-shifted matches file produced by add_uniform_cd.py.

Input columns expected:
  - year              (corrected year after the shift)
...
After the one-year glitch correction, post-census redistricting spikes should
appear at 1991/2001/2011/2021 — the years following each decennial census.
